from flcore.clients.client_alp_10th_algo_attention import clientalp_v10
from flcore.servers.serverbase import Server
from utils.data_utils import read_client_data
from utils.attention_weights_v6 import EnhancedSelfAttentionLayer
...
class Fed_alp_v10(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(clientalp_v10)
    ...
    def train(self):
        ...
        for i in range(self.global_rounds+1):
            ...
            client_label_proto_dict = self.generate_aggregated_protos(model)
    ...
    def generate_aggregated_protos(self,model):
        ...
        #model = EnhancedSelfAttentionLayer(feature_size, intermediate_size, num_attention_weights).to(self.device)
