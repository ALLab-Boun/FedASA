from flcore.clients.client_alp_7th_algo_attention import clientalp_v7
from flcore.servers.serverbase import Server
from utils.data_utils import read_client_data
from utils.attention_weights_v4 import EnhancedSelfAttentionLayer
...
class Fed_alp_v7(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(clientalp_v7)
